    ...
    <div className="relative w-full h-auto bg-[#0D371F]">
      <main className="relative z-10 min-h-screen bg-[#FCFAF6] mb-[572px] md:mb-[760px] rounded-b-2xl md:rounded-b-3xl">
        ...
        <div className="px-[16px] md:px-[40px] lg:px-[96px] xl:px-[172px] 2xl:px-[258px] pt-[172px] md:pt-[252px] pb-[96px] md:pb-32">
          ...
          {/* Title */}
          <section className="mb-[32px] md:mb-48">
            ...
            <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal max-w-3xl cascade-in" style={{ animationDelay: '0.5s' }}>October 15, 2025</p>
          </section>
          ...
          <div className="space-y-24 sm:space-y-32 md:space-y-40">
            ...
            <section>
              <div className="flex flex-col md:flex-row gap-6 md:gap-16">
                <div className="md:w-72 md:flex-shrink-0">
                  <h2 className="text-lg md:text-xl lg:text-2xl font-normal text-black cascade-in" style={{ animationDelay: '0.6s' }}>
                    The Origin
                  </h2>
                </div>
                <div className="flex-1 max-w-3xl space-y-12">
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '0.7s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '0.8s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '0.9s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '1.0s' }}>
            ...
            <section>
              <div className="flex flex-col md:flex-row gap-6 md:gap-16">
                <div className="md:w-72 md:flex-shrink-0">
                  <h2 className="text-lg md:text-xl lg:text-2xl font-normal text-black cascade-in" style={{ animationDelay: '1.1s' }}>
                    Act One
                  </h2>
                </div>
                <div className="flex-1 max-w-3xl space-y-12">
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '1.2s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '1.3s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '1.4s' }}>
                    By every external metric, we were winning.
                  </p>
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '1.5s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '1.6s' }}>
            ...
            <section>
              <div className="flex flex-col md:flex-row gap-6 md:gap-16">
                <div className="md:w-72 md:flex-shrink-0">
                  <h2 className="text-lg md:text-xl lg:text-2xl font-normal text-black cascade-in" style={{ animationDelay: '1.7s' }}>
                    The Pivot
                  </h2>
                </div>
                <div className="flex-1 max-w-3xl space-y-12">
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '1.8s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '1.9s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '2.0s' }}>
                    The workflow was a tax. The value was the outcome.
                  </p>
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '2.1s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '2.2s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '2.3s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '2.4s' }}>
            ...
            <section>
              <div className="flex flex-col md:flex-row gap-6 md:gap-16">
                <div className="md:w-72 md:flex-shrink-0">
                  <h2 className="text-lg md:text-xl lg:text-2xl font-normal text-black cascade-in" style={{ animationDelay: '2.5s' }}>
                    What We're Building
                  </h2>
                </div>
                <div className="flex-1 max-w-3xl space-y-12">
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '2.6s' }}>
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '2.7s' }}>The Core Insight</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '2.8s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '2.9s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '3.0s' }}>
                      Sauna brings this same revolution to knowledge work.
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '3.1s' }}>How It Works</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '3.2s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '3.3s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '3.4s' }}>
                      This is programming through demonstration:
                    </p>
                    <ul className="space-y-2 text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal pl-4 cascade-in" style={{ animationDelay: '3.5s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mt-4 cascade-in" style={{ animationDelay: '3.6s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '3.7s' }}>
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '3.8s' }}>The Architecture</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '3.9s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '4.0s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '4.1s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '4.2s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '4.3s' }}>
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '4.4s' }}>What Makes This Different</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '4.5s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '4.6s' }}>
                      Six months in, Sauna knows:
                    </p>
                    <ul className="space-y-2 text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal pl-4 mb-4 cascade-in" style={{ animationDelay: '4.7s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '4.8s' }}>
            ...
            <section>
              <div className="flex flex-col md:flex-row gap-6 md:gap-16">
                <div className="md:w-72 md:flex-shrink-0">
                  <h2 className="text-lg md:text-xl lg:text-2xl font-normal text-black cascade-in" style={{ animationDelay: '4.9s' }}>
                    Our Beliefs
                  </h2>
                </div>
                <div className="flex-1 max-w-3xl space-y-12">
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '5.0s' }}>
                    We're building Sauna because we believe a few things about how the world works:
                  </p>

                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '5.1s' }}>1. Intelligence is Commoditizing. Context is the Moat.</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '5.2s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '5.3s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '5.4s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '5.5s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '5.6s' }}>
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '5.7s' }}>2. Work Is Changing</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '5.8s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '5.9s' }}>
                      Chat was phase one. Dashboards for delegation are phase two.
                    </p>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '6.0s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '6.1s' }}>
                      The deep creative work that actually matters gets squeezed into whatever time is left.
                    </p>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '6.2s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '6.3s' }}>
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '6.4s' }}>3. Amplified Teams Beat Headcount</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '6.5s' }}>
                      The goal isn't one-person companies—it's 10X teams where each person owns dramatically more.
                    </p>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '6.6s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '6.7s' }}>
                      This is already happening in software engineering. It's about to happen everywhere else.
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '6.8s' }}>4. Batch Operations Are Where We Win</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '6.9s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '7.0s' }}>
                      Users process 20+ items at once, approve/edit/reject in minutes, and get back to creative work.
                    </p>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '7.1s' }}>
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '7.2s' }}>5. Human-in-the-Loop Beats Full Automation</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '7.3s' }}>
                      The most powerful AI agents aren't the most autonomous. They're the ones that nail human-agent collaboration.
                    </p>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '7.4s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '7.5s' }}>
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mb-3 cascade-in" style={{ animationDelay: '7.6s' }}>6. AGI Through Product, Not Just Intelligence</h3>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '7.7s' }}>
                      We believe AGI won't come from intelligence alone—it comes from integration.
                    </p>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '7.8s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '7.9s' }}>
                      That's the definition of AGI we care about: AI that's genuinely useful to as many people as possible.
                    </p>
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '8.0s' }}>
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '8.1s' }}>
            ...
            <section>
              <div className="flex flex-col md:flex-row gap-6 md:gap-16">
                <div className="md:w-72 md:flex-shrink-0">
                  <h2 className="text-lg md:text-xl lg:text-2xl font-normal text-black cascade-in" style={{ animationDelay: '8.2s' }}>
                    Where We Are Today
                  </h2>
                </div>
                <div className="flex-1 max-w-3xl space-y-12">
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '8.3s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '8.4s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '8.5s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '8.6s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '8.7s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '8.8s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '8.9s' }}>
            ...
            <section>
              <div className="flex flex-col md:flex-row gap-6 md:gap-16">
                <div className="md:w-72 md:flex-shrink-0">
                  <h2 className="text-lg md:text-xl lg:text-2xl font-normal text-black cascade-in" style={{ animationDelay: '9.0s' }}>
                    What Comes Next
                  </h2>
                </div>
                <div className="flex-1 max-w-3xl space-y-12">
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '9.1s' }}>
                    The last six months have been the hardest of the company's life. Complete pivot. Architectural rebuild. Team realignment.
                  </p>
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '9.2s' }}>
                    But we're through it. Product is clear, team is aligned, architecture is solid, early reactions are strong.
                  </p>
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-4 cascade-in" style={{ animationDelay: '9.3s' }}>
                    We're building for a future where:
                  </p>
                  <ul className="space-y-2 text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal pl-4 mb-6 cascade-in" style={{ animationDelay: '9.4s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '9.5s' }}>
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '9.6s' }}>
                    Sauna is our first proof that words can become adaptive, intelligent ware. But it won't be the last.
                  </p>
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal cascade-in" style={{ animationDelay: '9.7s' }}>
            ...
            <section className="pb-0">
              <div className="flex flex-col md:flex-row gap-6 md:gap-16">
                ...
                <div className="flex-1 max-w-3xl">
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black font-normal mb-2 cascade-in" style={{ animationDelay: '9.8s' }}>
                    Filip Kozera & Robert Chandler
                  </p>
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-gray-600 font-normal mb-1 cascade-in" style={{ animationDelay: '9.9s' }}>
                    Co-founders, Wordware
                  </p>
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-gray-600 font-normal mb-8 cascade-in" style={{ animationDelay: '10.0s' }}>
