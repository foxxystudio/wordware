          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-24">
            ...
            <div className="md:w-[65%] space-y-12">
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '0.7s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">1. Introduction</h2>
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '0.8s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">2. Information We Collect</h2>
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '0.9s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">3. How We Use Your Information</h2>
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '1.0s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">4. Data Storage and Analysis</h2>
                <p className="text-base md:text-lg leading-relaxed text-black font-normal">
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '1.1s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">5. Sharing of Information</h2>
                <p className="text-base md:text-lg leading-relaxed text-black font-normal">
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '1.2s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">6. Security</h2>
                <p className="text-base md:text-lg leading-relaxed text-black font-normal">
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '1.3s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">7. Your Rights</h2>
                <p className="text-base md:text-lg leading-relaxed text-black font-normal">
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '1.4s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">8. Changes to This Policy</h2>
                <p className="text-base md:text-lg leading-relaxed text-black font-normal">
              ...
              <div className="space-y-4 cascade-in" style={{ animationDelay: '1.5s' }}>
                <h2 className="text-xl md:text-2xl font-semibold text-black">9. Contact Us</h2>
                <p className="text-base md:text-lg leading-relaxed text-black font-normal">
